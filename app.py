...
html, body {
  ...
  min-height: 100%;
  background:
    radial-gradient(circle at 50% 0%, rgba(223,183,94,.12), transparent 24%),
    radial-gradient(circle at 10% 38%, rgba(86,183,216,.055), transparent 20%),
    radial-gradient(circle at 92% 35%, rgba(217,78,101,.045), transparent 20%),
...
.title {
  ...
  color: var(--gold);
  text-shadow: 0 0 13px rgba(223,183,94,.24);
  animation: titleGlow 4.8s ease-in-out infinite;
}
.title small { display: block; font-size: .62em; margin-top: .08em; }
@keyframes titleGlow {
  0%,100% { filter: brightness(.98); transform: translateY(0); }
...
.icon-btn {
  width: 34px;
  height: 34px;
  border: 1px solid rgba(223,183,94,.35);
  background: #14100a;
  color: var(--gold);
  font-size: 17px;
  font-weight: 900;
...
.icon-btn:hover {
  ...
  box-shadow: 0 0 14px rgba(223,183,94,.18);
...
.floaty {
  position: fixed;
  pointer-events: none;
  color: rgba(223,183,94,.32);
  font-size: 15px;
  animation: floaty 5.5s ease-in-out infinite alternate;
  z-index: 0;
}
.floaty.f1 { left: 8vw; top: 22vh; animation-delay: 0s; }
.floaty.f2 { right: 10vw; top: 28vh; animation-delay: .8s; color: rgba(86,183,216,.25); }
.floaty.f3 { left: 12vw; bottom: 18vh; animation-delay: 1.3s; color: rgba(217,78,101,.2); }
.floaty.f4 { right: 14vw; bottom: 22vh; animation-delay: 2s; }
@keyframes floaty {
  from { transform: translateY(0) rotate(-8deg); opacity: .2; }
  to { transform: translateY(-16px) rotate(8deg); opacity: .65; }
}
.boards {
  display: grid;
  gap: 12px;
...
.boards.one { grid-template-columns: minmax(290px, min(78vmin, 500px)); }
...
.board-shell {
  ...
  box-shadow: 0 0 18px rgba(0,0,0,.36), 0 0 20px rgba(223,183,94,.055);
}
.board {
  display: grid;
...
.boards.two .cell, .boards.three .cell, .boards.four .cell { font-size: clamp(8px, 1vw, 11px); }
.boards.five .cell, .boards.six .cell { font-size: clamp(7px, .75vw, 9px); }
.cell:hover {
  transform: translateY(-1px);
  border-color: rgba(223,183,94,.7);
  box-shadow: 0 0 10px rgba(223,183,94,.12);
  filter: brightness(1.08);
}
.cell.free {
  background: var(--purple);
  color: var(--gold);
  border-color: rgba(223,183,94,.65);
  font-style: italic;
...
.cell.rolling:not(.free) { animation: softRoll .28s ease; }
@keyframes softRoll {
...
.modal-backdrop.show { display: flex; animation: fadeIn .16s ease; }
@keyframes fadeIn { from { opacity: 0; } to { opacity: 1; } }
.modal {
  width: min(92vw, 390px);
  background: #101722;
  border: 1px solid rgba(223,183,94,.25);
  padding: 18px;
...
.modal h2 { margin: 0 0 10px; color: var(--gold); font-size: 30px; line-height: 1; }
.modal p { color: var(--text); margin: 8px 0; font-weight: 720; }
.close {
  margin-top: 14px;
  width: 100%;
  height: 36px;
...
@keyframes fall { to { transform: translateY(110vh) rotate(380deg); opacity: .2; } }
@media (max-width: 760px) {
  .boards.two, .boards.three, .boards.four, .boards.five, .boards.six {
    grid-template-columns: 1fr;
    width: min(94vw, 500px);
  }
  .cell, .boards.two .cell, .boards.three .cell, .boards.four .cell, .boards.five .cell, .boards.six .cell {
...
function rollBoards() {
  ...
  function spin(step) {
    ...
    cells().forEach((cell, idx) => {
      ...
      const pool = board.filter((_, i) => i !== 12);
